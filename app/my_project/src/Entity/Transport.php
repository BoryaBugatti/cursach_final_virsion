...
class Transport
{
    ...
    #[ORM\Column]
    private ?float $eкtransport_capacity = null;
    ...
    public function geteкtransportCapacity(): ?float
    {
        return $this->eкtransport_capacity;
    }

    public function seteкtransportCapacity(float $eкtransport_capacity): static
    {
        $this->eкtransport_capacity = $eкtransport_capacity;
